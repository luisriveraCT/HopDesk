...
.run_module("tests/test_vencidos_search_audit_logging.R")
.run_module("tests/test_sync_bus_coverage.R")
.run_module("tests/test_auth_keep_token.R")
.run_module("tests/test_live_refresh_observers.R")
.run_module("tests/test_bancos_vincular_retirement_and_manual_edit.R")
.run_module("tests/test_pasivos_audit_visibility.R")
.run_module("tests/test_log_action_completeness_scan.R")
.run_module("tests/test_stage9_touched_files_parse.R")
.run_module("tests/test_calendario_stage_sel_provision_guard.R")
.run_module("tests/test_stage_source_propagation.R")
.run_module("tests/test_stage14b_exhaustive_source_scan.R")
.run_module("tests/test_abono_parcial_audit.R")
.run_module("tests/test_pagar_hoy_db_stale_read_hardening.R")
.run_module("tests/test_cart_shared_documento_collision.R")
.run_module("tests/test_pagar_hoy_db_remaining_sites_hardening.R")
.run_module("tests/test_stage20_abono_followups.R")
.run_module("tests/test_abono_ab_rows_unboxing.R")
...
.run_module("tests/test_stage13_intercompany_confirmed.R")
