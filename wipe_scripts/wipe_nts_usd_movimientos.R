# =============================================================================
# wipe_nts_usd_movimientos.R
# ONE-TIME USE: hard-deletes all bancos_movimientos rows for ALL Networks
# Trucking Services USD account(s) — two accounts exist (NTSBB + unnamed).
# Run from the R console. Delete after use.
# =============================================================================
...
target_ctas <- ctas[
  toupper(trimws(ctas[["Empresa"]])) == "NTS" &
...
message("Done. Re-import the NTS USD TXT file(s) to rebuild clean history.")
