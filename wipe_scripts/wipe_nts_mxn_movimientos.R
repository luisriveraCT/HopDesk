# =============================================================================
# wipe_nts_mxn_movimientos.R
# ONE-TIME USE: hard-deletes all bancos_movimientos rows for the Networks
# Trucking Services MXN account(s). Run from the R console. Delete after use.
# =============================================================================
...
message("Done. Re-import the NTS MXN TXT file to rebuild clean history.")
