# =============================================================================
# wipe_nrs_usd_movimientos.R
# ONE-TIME USE: hard-deletes all bancos_movimientos rows for the Networks
# Realtors USD account(s). Run from the R console. Delete this file after running.
# =============================================================================
...
target_ctas <- ctas[
  toupper(trimws(ctas[["Empresa"]])) == "NRS" &
...
message("Done. Re-import the NRS USD TXT file to rebuild clean history.")
