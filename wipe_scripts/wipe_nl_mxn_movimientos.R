# =============================================================================
# wipe_nl_mxn_movimientos.R
# ONE-TIME USE: hard-deletes all bancos_movimientos rows for the Networks &
# Logistics MXN account(s). Run from the R console. Delete this file after running.
# =============================================================================
...
message("Done. Re-import the NL MXN TXT file to rebuild clean history.")
