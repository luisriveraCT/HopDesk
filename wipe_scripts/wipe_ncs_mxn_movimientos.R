# =============================================================================
# wipe_ncs_mxn_movimientos.R
# ONE-TIME USE: hard-deletes all bancos_movimientos rows for the Networks
# Crossdocking Services MXN account(s). Run from the R console. Delete after use.
# =============================================================================
...
message("Done. Re-import the NCS MXN TXT file to rebuild clean history.")
