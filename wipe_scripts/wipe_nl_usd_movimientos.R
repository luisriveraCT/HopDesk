# =============================================================================
# wipe_nl_usd_movimientos.R
# ONE-TIME USE: hard-deletes all bancos_movimientos rows for the Networks &
# Logistics USD account(s). Run from the R console. Delete this file after running.
# =============================================================================
...
target_ctas <- ctas[
  toupper(trimws(ctas[["Empresa"]])) == "NL" &
...
message("Done. Re-import the NL USD TXT file to rebuild clean history.")
